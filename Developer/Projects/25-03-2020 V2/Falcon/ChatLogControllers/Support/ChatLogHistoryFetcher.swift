...
protocol ChatLogHistoryDelegate: class {
  ...
  func chatLogHistory(updated messages: [FalconMessage], at indexPaths: [IndexPath])
}
...
class ChatLogHistoryFetcher: NSObject {
  ...
  fileprivate var messages = [FalconMessage]()
  fileprivate var conversation: Conversation?
  
  fileprivate var isGroupChat: Bool!
  fileprivate var messagesToLoad: Int!
  
  public func loadPreviousMessages(_ messages: [FalconMessage], _ conversation: Conversation,
  ...
  var previousMessages = [FalconMessage]()
  fileprivate func getMessages(from query: DatabaseQuery) {
    previousMessages = [FalconMessage]()
  ...
  fileprivate func getMetadata(fromMessageWith messageUID: String) {
    ...
    reference.observeSingleEvent(of: .value, with: { (snapshot) in
      ...
      let message = FalconMessage(dictionary: dictionary)
