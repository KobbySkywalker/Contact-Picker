...
class BaseMessageCell: RevealableCollectionViewCell {
  ...
  weak var message: FalconMessage?
  ...
  func configureDeliveryStatus(at indexPath: IndexPath, lastMessageIndex: Int, message: FalconMessage) {
  ...
  func setupTimestampView(message: FalconMessage, isOutgoing: Bool) {
    DispatchQueue.main.async {
