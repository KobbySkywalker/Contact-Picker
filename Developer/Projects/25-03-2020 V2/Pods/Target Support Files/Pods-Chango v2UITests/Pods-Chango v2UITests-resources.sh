...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/EPContactsPicker/Pods/EPContactCell.xib"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/EPContactsPicker-library/EPContactsPicker.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ESPullToRefresh-library/ESPullToRefresh.bundle"
