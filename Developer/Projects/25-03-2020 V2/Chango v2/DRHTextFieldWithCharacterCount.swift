...
@IBDesignable class DRHTextFieldWithCharacterCount: UITextView {
    ...
    weak var customDelegate: UITextViewDelegate?
...
extension DRHTextFieldWithCharacterCount: UITextViewDelegate {
    func textView(_ textView: UITextView, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        
        guard let text = textView.text , lengthLimit != 0 else { return true }
