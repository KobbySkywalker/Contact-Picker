...
class InAppNotificationManager: NSObject {
  ...
  func handleInAppSoundPlaying(message: FalconMessage, conversation: Conversation, conversations: [Conversation]) {
  ...
  fileprivate func subtitleForMessage(message: FalconMessage) -> String {
